    ...
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="border-4 border-black bg-white">
        <div className="px-6 py-4">
          <h3 className="font-mono text-3xl font-bold text-black">Summary</h3>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-6 gap-4 mb-4">
            <div>
              <div className="font-mono text-2xl font-bold text-black">{analysis.total_boats}</div>
              <div className="font-mono text-xs text-gray-600">Boats Scheduled</div>
            </div>
            <div>
              <div className="font-mono text-2xl font-bold text-black">{analysis.total_parts}</div>
              <div className="font-mono text-xs text-gray-600"># of SKUs</div>
            </div>
            <div>
              ...
              <div className="font-mono text-xs text-gray-600"># of Parts</div>
            </div>
            <div>
              <div className="font-mono text-2xl font-bold text-black">{analysis.total_suppliers}</div>
              <div className="font-mono text-xs text-gray-600">Suppliers</div>
            </div>
            <div>
              <div className="font-mono text-2xl font-bold text-black">${analysis.total_cost.toLocaleString()}</div>
              <div className="font-mono text-xs text-gray-600">Total Cost</div>
            </div>
            <div className="relative">
              <div className="font-mono text-xs text-gray-600 mb-1">Planning Horizon</div>
              <div className="font-mono text-sm mb-2 text-black">
              ...
              <button 
                ...
                className="text-xs py-1 px-2 bg-white hover:bg-gray-100 text-black border-2 border-black font-mono transition-colors"
              >
                {showHorizonConfig ? 'Hide' : 'Edit'} Dates
              </button>
            
              {/* Popover for date editing */}
              {showHorizonConfig && (
                <div className="absolute top-full mt-2 right-0 z-50 w-96 bg-white border-2 border-gray-300 shadow-lg">
                  <div className="p-4">
                    <div className="font-mono text-sm font-bold text-gray-900 mb-3">
                      Adjust Planning Horizon
                    </div>
                    
                    <div className="mb-3 p-2 bg-blue-50 border-l-2 border-blue-600">
                    ...
                    <div className="space-y-3 mb-3">
                      <div>
                        <label className="font-mono text-xs font-semibold text-gray-700 mb-1 block">
                          Start Date
                        </label>
                        <Input
                          type="date"
                    ...
                    {(startDate || endDate) && (
                      <div className="mt-3 p-2 bg-green-50 border-l-2 border-green-500">
          ...
          <div className="p-3 bg-green-50 border-l-4 border-green-500">
            <div className="font-mono text-sm text-gray-700">
              <strong className="text-black">Next Steps:</strong> Review the requirements below, then click "Configure POs" for each supplier to customize your purchase orders.
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="mb-4 flex justify-between items-start">
                <div className="font-mono text-sm text-gray-600">
                  ...
                  <div className="font-mono text-lg font-bold">
                    ${supplier.parts.reduce((sum, part) => {
                      const margin = safetyMargins[part.part_id] || 0
                      const adjustedQty = calculateNetWithMargin(
                        part.net_quantity_needed,
                        part.current_stock,
                      ...
                      return (
                        <Fragment key={part.part_id}>
                          ...
                          >
                            ...
                            <td className="text-right py-3 px-2">${part.unit_cost.toFixed(2)}</td>
                            ...
                            <tr className="bg-blue-50 border-b border-gray-200">
                              <td colSpan={8} className="py-4 px-6">
                                <div className="grid grid-cols-2 gap-6 text-xs">
                                  ...
                                  <div>
                                    <div className="font-bold text-gray-700 mb-2">Supplier & Timing</div>
                                    <div className="space-y-1 text-gray-600">
                                      <div className="flex justify-between">
                                        <span>Lead Time:</span>
